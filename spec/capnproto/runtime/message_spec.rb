...
describe CapnProto::Message, nil do
  describe ".from_buffer" do
    it "creates a new message from a buffer" do
      expect(MessageHelper.single_segment).must_be_instance_of(CapnProto::Message)
    end
    ...
    it "creates segments with the correct bounds" do
      expect(MessageHelper.single_segment.segments.fetch(0).bounds).must_equal(8...16)

      four_segments = MessageHelper.four_segment.segments
      expect(four_segments.fetch(0).bounds).must_equal(24...80)
      expect(four_segments.fetch(1).bounds).must_equal(80...96)
      expect(four_segments.fetch(2).bounds).must_equal(96...152)
      expect(four_segments.fetch(3).bounds).must_equal(152...192)
    end

    it "creates segments with the correct offsets" do
      expect(MessageHelper.single_segment.segments.fetch(0).position).must_equal(8)

      four_segments = MessageHelper.four_segment.segments
      expect(four_segments.fetch(0).position).must_equal(24)
      expect(four_segments.fetch(1).position).must_equal(80)
      expect(four_segments.fetch(2).position).must_equal(96)
      expect(four_segments.fetch(3).position).must_equal(152)
    end
    ...
    it "raises an error if the number of sizes does not match the number of segments" do
      ...
      expect { CapnProto::Message.new(CapnProto::IOBuffer.new(IO::Buffer.for(data))) }
  ...
  describe "#root" do
    it "returns a reference to the first pointer in the first segment" do
      ...
      expect(root.position).must_equal(24)
    end
  end
  ...
  describe "#dereference_pointer" do
    ...
    context "single far pointer" do
      it "dereferences a far pointer to a higher segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(0)
      ...
      it "dereferences a far pointer to a lower segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(1).offset_position(8)
        ref, content = MessageHelper.four_segment.dereference_pointer(pointer)
      ...
      it "raises an error if the segment ID is unknown" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(0).offset_position(16)
      ...
      it "raises an error if the offset is outside the targeted segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(0).offset_position(32)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
    ...
    context "double far pointer" do
      it "dereferences a far pointer to a higher segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2)
        ref, content = MessageHelper.four_segment.dereference_pointer(pointer)
        expect(ref.read_integer(0, false, 64)).must_equal(MessageHelper::STRUCT_POINTER_A)
      ...
      it "raises an error if the segment ID is unknown" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(8)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
      ...
      it "raises an error if the offset is outside the targeted segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(16)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
      ...
      it "raises an error if the nested far pointer is a double pointer" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(0).offset_position(48)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
      ...
      it "raises an error if the first word is not a nested far pointer" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(24)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
      ...
      it "raises an error if the second word is outside the segment" do
        ...
        #                             1+16: Invalid offset
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(32)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
      ...
      it "raises an error if the nested far pointer refers to an unknown segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(40)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(CapnProto::Error, "Unknown segment ID 9 in far pointer")
      end
      ...
      it "raises an error if the nested far pointer refers to an offset outside the segment" do
        ...
        pointer = MessageHelper.four_segment.segments.fetch(2).offset_position(48)
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(CapnProto::Error, "Invalid offset 32 for segment 1 in far pointer")
      end
    end
