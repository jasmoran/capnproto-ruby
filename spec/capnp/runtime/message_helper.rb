...
class MessageHelper
  ...
  STRUCT_POINTER_A = 0x0001000100000000
  ...
  sig { returns(Capnp::StreamMessage) }
  def self.single_segment
    ...
    message = Capnp::StreamMessage.new(Capnp::IOBuffer.new(IO::Buffer.for(data)))

    @single_segment ||= T.let(message, T.nilable(Capnp::StreamMessage))
  ...
  def self.four_segment
    ...
    message = Capnp::StreamMessage.new(Capnp::IOBuffer.new(IO::Buffer.for(header + segments)))

    @four_segment ||= T.let(message, T.nilable(Capnp::StreamMessage))
