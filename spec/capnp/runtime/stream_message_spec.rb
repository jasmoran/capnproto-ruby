...
describe Capnp::StreamMessage, nil do
  describe ".from_buffer" do
    it "creates a new message from a buffer" do
      expect(MessageHelper.single_segment).must_be_instance_of(Capnp::StreamMessage)
    end
    ...
    it "raises an error if the number of sizes does not match the number of segments" do
      ...
      expect { Capnp::StreamMessage.new(Capnp::IOBuffer.new(IO::Buffer.for(data))) }
  ...
  describe "#dereference_pointer" do
    ...
    context "single far pointer" do
      ...
      it "raises an error if the segment ID is unknown" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Unknown segment ID 9 in far pointer")
      end
      ...
      it "raises an error if the offset is outside the targeted segment" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Invalid offset 32 for segment 1 in far pointer")
      end
    end
    ...
    context "double far pointer" do
      ...
      it "raises an error if the segment ID is unknown" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Unknown segment ID 8 in far pointer")
      end
      ...
      it "raises an error if the offset is outside the targeted segment" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Invalid offset 64 for segment 1 in far pointer")
      end
      ...
      it "raises an error if the nested far pointer is a double pointer" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Double far pointer pointing to another double far pointer")
      end
      ...
      it "raises an error if the first word is not a nested far pointer" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "First word of double far pointer is not a far pointer")
      end
      ...
      it "raises an error if the second word is outside the segment" do
        ...
        expect { MessageHelper.four_segment.dereference_pointer(pointer) }
          .must_raise(Capnp::Error, "Invalid offset 8 for segment 1 in far pointer")
      end
